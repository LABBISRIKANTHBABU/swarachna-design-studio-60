      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FeatureCard 
            ...
            description="From logos to complete brand identities, we craft designs that tell your unique story."
          />
          <FeatureCard 
            number="02"
            title="Quality Printing"
            description="Premium printing services for all your business and personal needs with attention to detail."
          />
          <FeatureCard 
            number="03"
            title="Timely Delivery"
            description="We understand the importance of deadlines and ensure on-time delivery for all projects."
          />
          <FeatureCard 
            number="04"
            title="Custom Solutions"
            description="Tailor-made solutions to meet your specific requirements and exceed expectations."
          />
        </div>
        ...
        <div className="mt-24 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2 grid grid-cols-2 gap-6">
            <ProcessStep 
              number="01"
              title="Consultation"
              description="We start by understanding your needs and objectives."
            />
            <ProcessStep 
              number="02"
              title="Concept & Design"
              description="Our designers create concepts based on your requirements."
            />
            <ProcessStep 
              number="03"
              title="Refinement"
              description="We refine designs based on your feedback until perfect."
            />
            <ProcessStep 
              number="04"
              title="Production"
              description="Final designs are prepared for printing with quality checks."
            />
          </div>
        </div>
      </div>
