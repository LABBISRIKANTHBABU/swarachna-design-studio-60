            ...
            <div className="lg:col-span-2">
              <Card className="mb-6">
                <CardContent className="pt-6">
                  {items.map(item => <div key={item.id} className="flex items-center py-4 border-b last:border-0">
            ...
            <div>
              <Card>
                ...
                <CardFooter className="flex flex-col space-y-4">
                  {showCheckoutForm ? <CheckoutForm items={items} total={total > 0 ? total : 0} onSuccess={handlePaymentSuccess} /> : <>
                      <Button className="w-full bg-swarachna-burgundy hover:bg-swarachna-burgundy/90 text-white" onClick={handleCheckout}>
