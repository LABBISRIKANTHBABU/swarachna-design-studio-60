          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-10">
            <div className="overflow-hidden rounded-lg shadow-lg bg-white/80 backdrop-blur-sm">
              <div className="aspect-square overflow-hidden">
                <img 
                  src="/lovable-uploads/b796bec5-9e83-4ca6-85a7-90fbec2b6fd3.png" 
            ...
            <div className="overflow-hidden rounded-lg shadow-lg bg-white/80 backdrop-blur-sm">
              <div className="aspect-square overflow-hidden">
                <img 
                  src="/lovable-uploads/009d3efb-78c6-4820-a440-2124fc23f847.png" 
            ...
            <div className="overflow-hidden rounded-lg shadow-lg bg-white/80 backdrop-blur-sm hidden sm:block">
              <div className="aspect-square overflow-hidden">
                <img 
                  src="/lovable-uploads/cd54f1af-b065-43fa-8a3c-be71d282e7c5.png" 
            ...
            <div className="overflow-hidden rounded-lg shadow-lg bg-white/80 backdrop-blur-sm hidden lg:block">
              <div className="aspect-square overflow-hidden">
                <img 
                  src="/lovable-uploads/8e2a3ed1-cadd-4bf0-87e6-63c35866871b.png" 
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="w-full md:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold font-playfair mb-4">
                <span className="gold-text font-extrabold" style={{ textShadow: '0 1px 1px rgba(0,0,0,0.05)', WebkitTextStroke: '0.5px rgba(184, 134, 11, 0.5)' }}>Have Your Own Design?</span>
              </h2>
            ...
            <div className="w-full md:w-1/2 flex justify-center">
              <div className="relative w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                <img
                  src="/lovable-uploads/f3ce48ca-6d74-4d19-8d5d-0f0e76ab7078.png"
                  alt="Custom Design"
